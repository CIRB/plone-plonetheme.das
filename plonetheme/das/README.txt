...
First let's check that the view exists
    ...
    >>> from plonetheme.das.browser.dasview import themeView
...
visible.
    ...
    >>> from plonetheme.das.tests.base import zcml_string
    >>> zcml.load_string(zcml_string)
    >>> portal_setup = self.portal.portal_setup
    >>> portal_setup.runAllImportStepsFromProfile('profile-plonetheme.das:testing')
    {...}
    >>> browser.reload()
    >>> 'id="portal-column-one"' in browser.contents
    False
